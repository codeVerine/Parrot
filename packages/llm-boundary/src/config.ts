...
export const DEFAULT_LLM_BOUNDARY_CONFIG: LlmBoundaryConfig = {
  rolePromptPins: {
    planner: { rolePromptId: "planner", version: "1.8.0" },
    reviewer: { rolePromptId: "reviewer", version: "1.2.0" },
    adversarial: { rolePromptId: "adversarial", version: "1.2.0" },
    ...
    frontier: { rolePromptId: "frontier", version: "1.2.0" },
